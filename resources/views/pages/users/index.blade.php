        ...
        <div class="my-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="sm:flex mb-3 p-2">
                <div class="items-center mb-3 sm:flex sm:divide-x sm:divide-gray-100 sm:mb-0 dark:divide-gray-700">
                    <div class="flex flex-row gap-2 sm:flex-row sm:items-center">
                        <select name="statuspage" id="statuspage"
                        ...
                        <form class="w-full sm:w-auto" action="#" method="GET">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                    ...
                                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ...
                                        <td
                                            ...
                                            interfaces. In my spare time, I enjoys baking, hiking, and spending time with my
                                            family.</td>
                                        <td

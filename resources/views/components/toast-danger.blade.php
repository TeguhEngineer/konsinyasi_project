<div id="toast-danger"
    class="absolute right-0 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow-sm dark:text-gray-400 dark:bg-gray-800 transition-transform duration-300 ease-in-out transform translate-x-20 opacity-0"
    role="alert">
    <div
